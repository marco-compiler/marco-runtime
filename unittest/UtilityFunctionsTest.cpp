...
TEST(Runtime, clone_ai1_ai1) {
  std::array<bool, 6> destinationValues = {false, false, false,
                                           false, false, false};
  ...
  NAME_MANGLED(clone, void, ARRAY(bool), ARRAY(bool))(&unrankedDestination,
                                                      &unrankedSource);
...
TEST(Runtime, clone_ai1_ai32) {
  ...
  NAME_MANGLED(clone, void, ARRAY(bool), ARRAY(int32_t))(&unrankedDestination,
                                                         &unrankedSource);
...
TEST(Runtime, clone_ai1_ai64) {
  ...
  NAME_MANGLED(clone, void, ARRAY(bool), ARRAY(int64_t))(&unrankedDestination,
                                                         &unrankedSource);
...
TEST(Runtime, clone_ai1_af32) {
  ...
  NAME_MANGLED(clone, void, ARRAY(bool), ARRAY(float))(&unrankedDestination,
                                                       &unrankedSource);
...
TEST(Runtime, clone_ai1_af64) {
  ...
  NAME_MANGLED(clone, void, ARRAY(bool), ARRAY(double))(&unrankedDestination,
                                                        &unrankedSource);
...
TEST(Runtime, clone_ai32_ai1) {
  ...
  NAME_MANGLED(clone, void, ARRAY(int32_t), ARRAY(bool))(&unrankedDestination,
                                                         &unrankedSource);
...
TEST(Runtime, clone_ai32_ai32) {
  ...
  NAME_MANGLED(clone, void, ARRAY(int32_t),
...
TEST(Runtime, clone_ai32_af32) {
  ...
  NAME_MANGLED(clone, void, ARRAY(int32_t), ARRAY(float))(&unrankedDestination,
                                                          &unrankedSource);
...
TEST(Runtime, clone_ai32_af64) {
  ...
  NAME_MANGLED(clone, void, ARRAY(int32_t), ARRAY(double))(&unrankedDestination,
                                                           &unrankedSource);
...
TEST(Runtime, clone_ai64_ai1) {
  ...
  NAME_MANGLED(clone, void, ARRAY(int64_t), ARRAY(bool))(&unrankedDestination,
                                                         &unrankedSource);
...
TEST(Runtime, clone_ai64_ai32) {
  ...
  NAME_MANGLED(clone, void, ARRAY(int64_t),
               ARRAY(int32_t))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, clone_ai64_af32) {
  ...
  NAME_MANGLED(clone, void, ARRAY(int64_t), ARRAY(float))(&unrankedDestination,
                                                          &unrankedSource);
...
TEST(Runtime, clone_ai64_af64) {
  ...
  NAME_MANGLED(clone, void, ARRAY(int64_t), ARRAY(double))(&unrankedDestination,
                                                           &unrankedSource);
...
TEST(Runtime, clone_af32_ai1) {
  ...
  NAME_MANGLED(clone, void, ARRAY(float), ARRAY(bool))(&unrankedDestination,
                                                       &unrankedSource);
...
TEST(Runtime, clone_af32_ai32) {
  ...
  NAME_MANGLED(clone, void, ARRAY(float), ARRAY(int32_t))(&unrankedDestination,
                                                          &unrankedSource);
...
TEST(Runtime, clone_af32_ai64) {
  ...
  NAME_MANGLED(clone, void, ARRAY(float), ARRAY(int64_t))(&unrankedDestination,
                                                          &unrankedSource);
...
TEST(Runtime, clone_af32_af32) {
  ...
  NAME_MANGLED(clone, void, ARRAY(float), ARRAY(float))(&unrankedDestination,
                                                        &unrankedSource);
...
TEST(Runtime, clone_af32_af64) {
  ...
  NAME_MANGLED(clone, void, ARRAY(float), ARRAY(double))(&unrankedDestination,
                                                         &unrankedSource);
...
TEST(Runtime, clone_af64_ai1) {
  ...
  NAME_MANGLED(clone, void, ARRAY(double), ARRAY(bool))(&unrankedDestination,
                                                        &unrankedSource);
...
TEST(Runtime, clone_af64_ai32) {
  ...
  NAME_MANGLED(clone, void, ARRAY(double), ARRAY(int32_t))(&unrankedDestination,
                                                           &unrankedSource);
...
TEST(Runtime, clone_af64_ai64) {
  ...
  NAME_MANGLED(clone, void, ARRAY(double), ARRAY(int64_t))(&unrankedDestination,
                                                           &unrankedSource);
...
TEST(Runtime, clone_af64_af32) {
  ...
  NAME_MANGLED(clone, void, ARRAY(double), ARRAY(float))(&unrankedDestination,
                                                         &unrankedSource);
...
TEST(Runtime, clone_af64_af64) {
  ...
  NAME_MANGLED(clone, void, ARRAY(double), ARRAY(double))(&unrankedDestination,
                                                          &unrankedSource);
