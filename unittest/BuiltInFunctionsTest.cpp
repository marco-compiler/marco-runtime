...
TEST(Runtime, diagonalSquareMatrix_i1_i1) {
  std::array<bool, 9> destinationValues = {false, true, true, true, false,
  ...
  NAME_MANGLED(diagonal, void, ARRAY(bool), ARRAY(bool))(&unrankedDestination,
                                                         &unrankedSource);
...
TEST(Runtime, diagonalSquareMatrix_i1_i32) {
  ...
  NAME_MANGLED(diagonal, void, ARRAY(bool),
               ARRAY(int32_t))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, diagonalSquareMatrix_i1_i64) {
  ...
  NAME_MANGLED(diagonal, void, ARRAY(bool),
               ARRAY(int64_t))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, diagonalSquareMatrix_i1_f32) {
  ...
  NAME_MANGLED(diagonal, void, ARRAY(bool), ARRAY(float))(&unrankedDestination,
                                                          &unrankedSource);
...
TEST(Runtime, diagonalSquareMatrix_i1_f64) {
  ...
  NAME_MANGLED(diagonal, void, ARRAY(bool), ARRAY(double))(&unrankedDestination,
                                                           &unrankedSource);
...
TEST(Runtime, diagonalSquareMatrix_i32_i1) {
  std::array<int32_t, 9> destinationValues = {-1, -1, -1, -1, -1,
                                              -1, -1, -1, -1};
  std::array<bool, 3> sourceValues = {true, true, true};
  ...
  NAME_MANGLED(diagonal, void, ARRAY(int32_t),
               ARRAY(bool))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, diagonalSquareMatrix_i32_f32) {
  ...
  NAME_MANGLED(diagonal, void, ARRAY(int32_t),
               ARRAY(float))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, diagonalSquareMatrix_i32_f64) {
  ...
  NAME_MANGLED(diagonal, void, ARRAY(int32_t),
               ARRAY(double))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, diagonalSquareMatrix_i64_i1) {
  std::array<int64_t, 9> destinationValues = {-1, -1, -1, -1, -1,
                                              -1, -1, -1, -1};
  std::array<bool, 3> sourceValues = {true, true, true};
  ...
  NAME_MANGLED(diagonal, void, ARRAY(int64_t),
               ARRAY(bool))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, diagonalSquareMatrix_f32_i1) {
  ...
  NAME_MANGLED(diagonal, void, ARRAY(float), ARRAY(bool))(&unrankedDestination,
                                                          &unrankedSource);
...
TEST(Runtime, diagonalSquareMatrix_f32_i32) {
  ...
  NAME_MANGLED(diagonal, void, ARRAY(float),
               ARRAY(int32_t))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, diagonalSquareMatrix_f32_f32) {
  ...
  NAME_MANGLED(diagonal, void, ARRAY(float), ARRAY(float))(&unrankedDestination,
                                                           &unrankedSource);
...
TEST(Runtime, diagonalSquareMatrix_f64_i1) {
  std::array<double, 9> destinationValues = {-1, -1, -1, -1, -1,
                                             -1, -1, -1, -1};
  std::array<bool, 3> sourceValues = {true, true, true};
  ...
  NAME_MANGLED(diagonal, void, ARRAY(double), ARRAY(bool))(&unrankedDestination,
                                                           &unrankedSource);
...
TEST(Runtime, diagonalSquareMatrix_f64_i32) {
  ...
  NAME_MANGLED(diagonal, void, ARRAY(double),
               ARRAY(int32_t))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, identitySquareMatrix_i1) {
  std::array<bool, 9> values = {false, true, true, true, false,
                                true,  true, true, false};
...
TEST(Runtime, linspace_i1) {
  ...
  NAME_MANGLED(linspace, void, ARRAY(bool), double, double)(&unrankedArray,
                                                            start, end);
...
TEST(Runtime, linspace_i32) {
  ...
  NAME_MANGLED(linspace, void, ARRAY(int32_t), double, double)(&unrankedArray,
                                                               start, end);

  for (size_t i = 0; i < data.size(); ++i) {
    EXPECT_EQ(array[i], static_cast<int32_t>(
                            (start + i * (end - start) / (data.size() - 1))));
  }
}
...
TEST(Runtime, linspace_i64) {
  ...
  NAME_MANGLED(linspace, void, ARRAY(int64_t), double, double)(&unrankedArray,
                                                               start, end);

  for (size_t i = 0; i < data.size(); ++i) {
    EXPECT_EQ(array[i], static_cast<int64_t>(
                            (start + i * (end - start) / (data.size() - 1))));
  }
}
...
TEST(Runtime, linspace_f32) {
  ...
  NAME_MANGLED(linspace, void, ARRAY(float), double, double)(&unrankedArray,
                                                             start, end);
...
TEST(Runtime, linspace_f64) {
  ...
  NAME_MANGLED(linspace, void, ARRAY(double), double, double)(&unrankedArray,
                                                              start, end);
...
TEST(Runtime, product_ai1) {
  ...
  EXPECT_EQ(result, static_cast<bool>(std::accumulate(
...
TEST(Runtime, product_ai32) {
  ...
  EXPECT_EQ(result, static_cast<int32_t>(std::accumulate(
                        values.begin(), values.end(), 1, std::multiplies<>())));
}
...
TEST(Runtime, product_ai64) {
  ...
  EXPECT_EQ(result, static_cast<int64_t>(std::accumulate(
                        values.begin(), values.end(), 1, std::multiplies<>())));
}
...
TEST(Runtime, product_af32) {
  ...
  EXPECT_FLOAT_EQ(
      result, static_cast<float>(std::accumulate(values.begin(), values.end(),
                                                 1, std::multiplies<>())));
}
...
TEST(Runtime, product_af64) {
  ...
  EXPECT_DOUBLE_EQ(
      result, static_cast<double>(std::accumulate(values.begin(), values.end(),
                                                  1, std::multiplies<>())));
}
...
TEST(Runtime, sum_ai1) {
  ...
  EXPECT_EQ(result, static_cast<bool>(std::accumulate(
                        values.begin(), values.end(), 0, std::plus<>())));
}
...
TEST(Runtime, sum_ai32) {
  ...
  EXPECT_EQ(result, (int32_t)std::accumulate(values.begin(), values.end(), 0,
                                             std::plus<>()));
}
...
TEST(Runtime, sum_ai64) {
  ...
  EXPECT_EQ(result, (int64_t)std::accumulate(values.begin(), values.end(), 0,
                                             std::plus<>()));
}
...
TEST(Runtime, sum_af32) {
  ...
  EXPECT_FLOAT_EQ(result, (float)std::accumulate(values.begin(), values.end(),
                                                 0, std::plus<>()));
}
...
TEST(Runtime, sum_af64) {
  ...
  EXPECT_DOUBLE_EQ(result, (double)std::accumulate(values.begin(), values.end(),
                                                   0, std::plus<>()));
}

TEST(Runtime, symmetric_ai1_ai1) {
  std::array<bool, 9> sourceValues = {true, false, true,  true, false,
                                      true, true,  false, true};
  std::array<bool, 9> destinationValues = {true, false, true,  true, false,
                                           true, true,  false, true};
  ...
  NAME_MANGLED(symmetric, void, ARRAY(bool), ARRAY(bool))(&unrankedDestination,
                                                          &unrankedSource);
...
TEST(Runtime, symmetric_ai1_ai32) {
  ...
  NAME_MANGLED(symmetric, void, ARRAY(bool),
               ARRAY(int32_t))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, symmetric_ai1_af32) {
  ...
  NAME_MANGLED(symmetric, void, ARRAY(bool), ARRAY(float))(&unrankedDestination,
                                                           &unrankedSource);
...
TEST(Runtime, symmetric_ai32_ai1) {
  ...
  NAME_MANGLED(symmetric, void, ARRAY(int32_t),
               ARRAY(bool))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, symmetric_ai64_ai1) {
  ...
  NAME_MANGLED(symmetric, void, ARRAY(int64_t),
               ARRAY(bool))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, symmetric_af32_ai1) {
  ...
  NAME_MANGLED(symmetric, void, ARRAY(float), ARRAY(bool))(&unrankedDestination,
                                                           &unrankedSource);
...
TEST(Runtime, symmetric_af32_ai32) {
  ...
  NAME_MANGLED(symmetric, void, ARRAY(float),
               ARRAY(int32_t))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, symmetric_af64_ai1) {
  ...
  NAME_MANGLED(symmetric, void, ARRAY(double),
               ARRAY(bool))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, transpose_ai1_ai1) {
  ...
  std::array<bool, 6> destinationValues = {true,  false, true,
                                           false, true,  false};
  ...
  NAME_MANGLED(transpose, void, ARRAY(bool), ARRAY(bool))(&unrankedDestination,
                                                          &unrankedSource);
...
TEST(Runtime, transpose_ai1_ai32) {
  ...
  NAME_MANGLED(transpose, void, ARRAY(bool),
               ARRAY(int32_t))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, transpose_ai1_af32) {
  ...
  NAME_MANGLED(transpose, void, ARRAY(bool), ARRAY(float))(&unrankedDestination,
                                                           &unrankedSource);
...
TEST(Runtime, transpose_ai32_ai1) {
  ...
  NAME_MANGLED(transpose, void, ARRAY(int32_t),
               ARRAY(bool))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, transpose_ai64_ai1) {
  ...
  NAME_MANGLED(transpose, void, ARRAY(int64_t),
               ARRAY(bool))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, transpose_af32_ai1) {
  ...
  NAME_MANGLED(transpose, void, ARRAY(float), ARRAY(bool))(&unrankedDestination,
                                                           &unrankedSource);
...
TEST(Runtime, transpose_af32_ai32) {
  ...
  NAME_MANGLED(transpose, void, ARRAY(float),
               ARRAY(int32_t))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, transpose_af64_ai1) {
  ...
  NAME_MANGLED(transpose, void, ARRAY(double),
               ARRAY(bool))(&unrankedDestination, &unrankedSource);
...
TEST(Runtime, assert_void)
{
  auto assertFn = [](bool cond, char* msg, int64_t assertionLevel) -> void {
    return NAME_MANGLED(assert, void, bool, PTR(void), int64_t)(cond, (void*)msg, assertionLevel);
  };
  ...
  EXPECT_EXIT(
    ...
    testing::KilledBySignal(SIGABRT), "Warning: " + s);
  EXPECT_EXIT(
    assertFn(false, s.data(), 1),
    testing::KilledBySignal(SIGABRT), "Error: " + s);
}