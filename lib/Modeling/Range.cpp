...
Range::Range(int64_t begin, int64_t end) : begin(begin), end(end) {}
...
RangeIterator::RangeIterator(int64_t begin, int64_t end)
...
int64_t RangeIterator::operator*() const { return current_; }
} // namespace marco::runtime
