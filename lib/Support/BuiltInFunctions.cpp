...
namespace {
bool abs_i1(bool value) { return value; }

int32_t abs_i32(int32_t value) { return std::abs(value); }

int64_t abs_i64(int64_t value) { return std::abs(value); }

float abs_f32(float value) { return std::abs(value); }

double abs_f64(double value) { return std::abs(value); }
} // namespace
...
namespace {
float acos_f32(float value) { return std::acos(value); }

double acos_f64(double value) { return std::acos(value); }
} // namespace
...
namespace {
float asin_f32(float value) { return std::asin(value); }

double asin_f64(double value) { return std::asin(value); }
} // namespace
...
namespace {
float atan_f32(float value) { return std::atan(value); }

double atan_f64(double value) { return std::atan(value); }
} // namespace
...
namespace {
float atan2_f32(float y, float x) { return std::atan2(y, x); }

double atan2_f64(double y, double x) { return std::atan2(y, x); }
} // namespace
...
namespace {
bool ceil_i1(bool value) { return value; }

int32_t ceil_i32(int32_t value) { return value; }

int64_t ceil_i64(int64_t value) { return value; }

float ceil_f32(float value) { return std::ceil(value); }

double ceil_f64(double value) { return std::ceil(value); }
} // namespace
...
namespace {
float cos_f32(float value) { return std::cos(value); }

double cos_f64(double value) { return std::cos(value); }
} // namespace
...
namespace {
float cosh_f32(float value) { return std::cosh(value); }

double cosh_f64(double value) { return std::cosh(value); }
} // namespace
...
void diagonal_void(UnrankedMemRefType<T> *destination,
                   UnrankedMemRefType<U> *values) {
  ...
  assert(std::all_of(dynamicDestination.sizes,
  ...
  for (auto it = std::begin(dynamicDestination),
            end = std::end(dynamicDestination);
       it != end; ++it) {
    auto indices = it.getIndices();
    assert(!indices.empty());

    bool isIdentityAccess =
        std::all_of(indices.begin(), indices.end(),
                    [&indices](const auto &i) { return i == indices[0]; });
...
float div_f32(float x, float y) { return std::trunc(x / y); }

double div_f64(double x, double y) { return std::trunc(x / y); }
} // namespace
...
namespace {
float exp_f32(float value) { return std::exp(value); }

double exp_f64(double value) { return std::exp(value); }
} // namespace
...
namespace {
bool floor_i1(bool value) { return value; }

int32_t floor_i32(int32_t value) { return value; }

int64_t floor_i64(int64_t value) { return value; }

float floor_f32(float value) { return std::floor(value); }

double floor_f64(double value) { return std::floor(value); }
} // namespace
...
void identity_void(UnrankedMemRefType<T> *array) {
  ...
  assert(std::all_of(
      dynamicArray.sizes, dynamicArray.sizes + dynamicArray.rank,
      [&](int64_t dimension) { return dimension == dynamicArray.sizes[0]; }));

  // Directly use the iterators, as we need to determine the current indexes
  // so that we can place a 1 if the access is on the matrix diagonal.

  for (auto it = std::begin(dynamicArray), end = std::end(dynamicArray);
       it != end; ++it) {
...
namespace {
bool integer_i1(bool value) { return value; }

int32_t integer_i32(int32_t value) { return value; }

int64_t integer_i64(int64_t value) { return value; }

float integer_f32(float value) { return std::floor(value); }

double integer_f64(double value) { return std::floor(value); }
} // namespace
...
bool maxArray_i1(UnrankedMemRefType<bool> *array) {
  ...
  return std::any_of(std::begin(dynamicArray), std::end(dynamicArray),
...
bool maxScalars_i1(bool x, bool y) { return x || y; }

int32_t maxScalars_i32(int32_t x, int32_t y) { return ::maxScalars(x, y); }

int64_t maxScalars_i64(int64_t x, int64_t y) { return ::maxScalars(x, y); }

float maxScalars_f32(float x, float y) { return ::maxScalars(x, y); }

double maxScalars_f64(double x, double y) { return ::maxScalars(x, y); }
} // namespace
...
bool minArray_i1(UnrankedMemRefType<bool> *array) {
  ...
  return std::all_of(std::begin(dynamicArray), std::end(dynamicArray),
                     [](const bool &value) { return value; });
}
...
bool minScalars_i1(bool x, bool y) { return x && y; }

int32_t minScalars_i32(int32_t x, int32_t y) { return ::minScalars(x, y); }

int64_t minScalars_i64(int64_t x, int64_t y) { return ::minScalars(x, y); }

float minScalars_f32(float x, float y) { return ::minScalars(x, y); }

double minScalars_f64(double x, double y) { return ::minScalars(x, y); }
} // namespace
...
float mod_f32(float x, float y) { return x - std::floor(x / y) * y; }

double mod_f64(double x, double y) { return x - std::floor(x / y) * y; }
} // namespace
...
T product(UnrankedMemRefType<T> *array) {
  DynamicMemRefType<T> dynamicArray(*array);
  return std::accumulate(std::begin(dynamicArray), std::end(dynamicArray),
...
float product_f32(UnrankedMemRefType<float> *array) { return ::product(array); }
...
int32_t rem_i32(int32_t x, int32_t y) { return x % y; }

int64_t rem_i64(int64_t x, int64_t y) { return x % y; }

float rem_f32(float x, float y) { return std::fmod(x, y); }

double rem_f64(double x, double y) { return std::fmod(x, y); }
} // namespace
...
namespace {
float sin_f32(float value) { return std::sin(value); }

double sin_f64(double value) { return std::sin(value); }
} // namespace
...
namespace {
float sinh_f32(float value) { return std::sinh(value); }

double sinh_f64(double value) { return std::sinh(value); }
} // namespace
...
int32_t sum_i32(UnrankedMemRefType<int32_t> *array) { return ::sum(array); }

int64_t sum_i64(UnrankedMemRefType<int64_t> *array) { return ::sum(array); }

float sum_f32(UnrankedMemRefType<float> *array) { return ::sum(array); }

double sum_f64(UnrankedMemRefType<double> *array) { return ::sum(array); }
} // namespace
...
void symmetric_void(UnrankedMemRefType<Destination> *destination,
                    UnrankedMemRefType<Source> *source) {
  // The two arrays must have exactly two dimensions
  assert(destination->rank == 2);
  assert(source->rank == 2);

  auto destinationMatrix =
      static_cast<StridedMemRefType<Destination, 2> *>(destination->descriptor);
  auto sourceMatrix =
      static_cast<StridedMemRefType<Source, 2> *>(source->descriptor);
...
namespace {
float tan_f32(float value) { return std::tan(value); }

double tan_f64(double value) { return std::tan(value); }
} // namespace
...
namespace {
float tanh_f32(float value) { return std::tanh(value); }

double tanh_f64(double value) { return std::tanh(value); }
} // namespace
...
/// @param source  		  source matrix
template <typename Destination, typename Source>
void transpose_void(UnrankedMemRefType<Destination> *destination,
                    UnrankedMemRefType<Source> *source) {
  // The two arrays must have exactly two dimensions
  assert(destination->rank == 2);
  assert(source->rank == 2);
  ...
  for (auto it = sourceMatrix->begin(), end = sourceMatrix->end(); it != end;
       ++it) {
    ...
    for (auto revIt = indexes.rbegin(), revEnd = indexes.rend();
         revIt != revEnd; ++revIt) {
