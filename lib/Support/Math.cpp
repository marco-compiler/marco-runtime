...
bool pow_i1(bool base, bool exp) { return ::pow_boolBase(base, exp); }

bool pow_i1(bool base, int32_t exp) { return ::pow_boolBase(base, exp); }

bool pow_i1(bool base, int64_t exp) { return ::pow_boolBase(base, exp); }

bool pow_i1(bool base, float exp) { return ::pow_boolBase(base, exp); }

bool pow_i1(bool base, double exp) { return ::pow_boolBase(base, exp); }
