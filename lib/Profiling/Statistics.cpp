...
void Statistics::printHeaderTitle(size_t width,
...
void Statistics::printHeader(size_t width, const std::string &title) const {
  printHeaderLine(width);
  printHeaderTitle(width, title);
  printHeaderLine(width);
}

void Statistics::printProfilerTitle(size_t width,
                                    const std::string &title) const {
